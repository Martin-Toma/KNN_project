...
log_files = ['log6dropout2', 'log6dropout05', 'log6r32a64']
rename = {
    'log6dropout2': "Dropout 0.2", 
    'log6dropout05': "Dropout 0.05",
    'log6r32a64': "Dropout 0.1",
}
...
plt.subplot(1, 2, 1)
plt.title("Training Loss over Epochs (Rank 32 Alpha 64)")
plt.xlabel("Epoch")
plt.ylabel("Loss")
plt.grid(True)

plt.subplot(1, 2, 2)
plt.title("Mean Token Accuracy over Epochs (Rank 32 Alpha 64)")
plt.xlabel("Epoch")
plt.ylabel("Accuracy")
plt.grid(True)
