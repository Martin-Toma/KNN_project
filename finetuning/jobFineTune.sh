...
#PBS -m ae
singularity run -B $SCRATCHDIR --nv /cvmfs/singularity.metacentrum.cz/NGC/PyTorch:25.02-py3.SIF /storage/brno12-cerit/home/martom198/lora/run_finetuning.sh 2
